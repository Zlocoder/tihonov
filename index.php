...
@include("inc/_header.php");
		...
		if(isset($_GET["menu"])){
			...
			switch($menu){
                ...
                case "faq": include("pages/_faq.php"); break; // TOP
				...
				case "support": include("pages/support.php"); break; // Выплаты
...
$content = str_replace('{!BALANCE_Z!}', sprintf("%.2f", $balance["money_s"]) ,$content);
	}
