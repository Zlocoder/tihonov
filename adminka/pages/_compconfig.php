...
<div class="">	
<div class="s-bk-lf">
	<div class="tit">Конкурс рефералов</div>
</div>
<div style="padding:20px">
<div class="silver-bk">
<div class="clr"></div>

<center><a href = "index.php?menu=compconfig" class="stn">Текущий конкурс</a> || <a href = "index.php?menu=compconfig&add" class="stn">Добавить Конкурс</a> || <a href = "index.php?menu=compconfig&list" class="stn">Завершенные</a></center>
<BR />
<?PHP
...
if(isset($_GET["add"])){
	...
	echo "<center><b><font color = 'black'>Максимум действующий конкурс. <BR />Завершите прошлый, чтоб создать новый</font></b></center><BR />";
...
<br /><br />
		...
		}else echo "<center><b><font color = 'black'>1е место должно быть больше второго, 2е место больше третего</font></b></center><BR />";
...
<table width="50%" border="0" align="center">
  ...
  <tr>
    <td align="center" colspan="2"><input type="submit" value="Создать конкурс" class="button25"></td>
  </tr>
...
if(isset($_GET["list"])){
	...
	}else echo "<center><b><font color = 'black'>Нет завершенных конкурсов</font></b></center><BR />";
...
if(isset($_POST["cancel"])){
	...
	}else echo "<center><b><font color = 'black'>Конкурс с указанным ID не найден, возможно он уже завершен</font></b></center><BR />";
	...
	if($db->NumRows() == 1){
		...
		if($db->NumRows() > 0){
			...
			while($data = $db->FetchArray()){
				...
				$money = ($money * $data_cq["ser_per_wmz"]); 
				# Зачисляем средства победителям
				$db->Query("UPDATE db_users_b SET money_b = money_b + '{$money}' WHERE id = '{$user_up_id}'", false, false);
...
<?=($comp["date_end"] < time()) ? '<center><font color = "black">!ДАТА ОКОНЧАНИЯ КОНКУРСА ПРОШЛА!</font></center>' : false; ?>
</b>
<BR />
...
<table width="350" border="0" align="center">
  <tr=>
	...
	<form action="" method="post">
		...
		<input type="submit" value="Отменить без призов"  class="button25"/>
	</form>
	</td>
	<td align="center">
	<form action="" method="post">
		<input type="hidden" name="set_ok" value="<?=$comp["id"]; ?>" />
		<input type="submit" value="Завершить и зачислить средства" class="button25" />
	</form>
	</td>
  </tr>
</table>
...
<BR />
	...
	}else echo "<center><b><font color = 'black'>Нет участников в конкурсе</font></b></center><BR />";

}else echo "<center><b><font color = 'black'>В данный момент конкурс не проводится</font></b></center><BR />";
