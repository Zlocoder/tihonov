...
<div class="">	
<div class="s-bk-lf">
	<div class="tit">История обменов</div>
</div>
...
$tdadd = time() - 5*60;
	if(isset($_POST["clean"])){
		...
		$db->Query("DELETE FROM db_swap_ser WHERE date_add < '$tdadd'");
		echo "<center><font color = 'green'><b>Очищено</b></font></center><BR />";
	}

$db->Query("SELECT * FROM db_swap_ser ORDER BY id DESC");

if($db->NumRows() > 0){

?>
<table cellpadding='3' cellspacing='0' border='0'  align='center' width="99%">
  <tr bgcolor="#efefef" class="title7">
    <td align="center" width="50" class="title7">ID</td>
    <td align="center" class="title7">Пользователь</td>
    <td align="center" width="75" class="title7">Отдал</td>
	<td align="center" width="75" class="title7">Получил</td>
...
<?PHP
    ...
    <td align="center" width="75" class="message1"><?=$data["amount_p"]; ?></td>
	<td align="center" width="75" class="message1"><?=$data["amount_b"]; ?></td>
