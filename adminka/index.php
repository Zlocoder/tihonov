<?PHP
######################################
# Скрипт Fruit Farm Edition WmRush
# Автор WmRush
# ICQ: 578598778
# Skype: molart111
######################################
...
if(isset($_GET["menu"])){
	...
	switch($smenu){
		...
		case "knb": include("pages/_knb.php"); break; // Истрия КНБ
		...
		case "pay_systems": include("pages/_pay_systems.php"); break; // Список платежных систем
		case "viplat": include("pages/_viplat.php"); break; // выплаты
		case "tp": include("pages/tp.php"); break; // тикеты 
		case "top": include("pages/_top.php"); break; // ТОП
        case "invcompconfig": include("pages/_invcompconfig.php"); break; // ТОП
        
        case "multi": include("pages/_multi.php"); break; // Мульти акк
